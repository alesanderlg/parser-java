...
@Entity
@Table(name = "log_more_than_250")
public class LogAccessMoreThan250 implements Serializable{
	...
	public LogAccessMoreThan250() {
		// TODO Auto-generated constructor stub
	}
	
	public LogAccessMoreThan250(long ipAddress, long count) {
		this.ipAddress = ipAddress;
		this.count = count;
		this.comments = "It's IP was blocked because made more than 250 request in 24 hour";
	}
	...
	public String toString() {
		...
		sb.append("class LogAccessMoreThan250 {\n");
	...
	public boolean equals(Object o) {
		...
		LogAccessMoreThan250 logAccessMoreThan100 = (LogAccessMoreThan250) o;
